      ...
      <section className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-6">Submissão de Trabalhos</h1>
            <p className="text-xl text-gray-200">Compartilhe suas pesquisas e experiências no CONCIFA 2025</p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Card className="mb-12">
                <CardHeader>
                  <h2 className="text-2xl font-bold text-blue-900">Informações Gerais</h2>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="flex flex-col items-center text-center p-4 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-gray-700">15 de Julho de 2025</p>
                    </div>

                    <div className="flex flex-col items-center text-center p-4 bg-blue-50 rounded-lg">
                      <FileText className="h-10 w-10 text-blue-600 mb-3" />
                      <h3 className="font-bold mb-1">Modalidades</h3>
                      <p className="text-gray-700">Artigos, Resumos e Pôsteres</p>
                    </div>

                    <div className="flex flex-col items-center text-center p-4 bg-blue-50 rounded-lg">
                      <CheckCircle className="h-10 w-10 text-blue-600 mb-3" />
                      <h3 className="font-bold mb-1">Resultado</h3>
                      <p className="text-gray-700">15 de Agosto de 2025</p>
                    </div>
                  </div>

                  <p className="text-gray-700 mb-4">
                    O CONCIFA 2025 convida pesquisadores, profissionais e estudantes a submeterem trabalhos científicos
                    relacionados às ciências forenses e áreas afins, com ênfase no tema central do evento: "As
                    Interfaces das Inteligências: Tecnologias, Inovações e Habilidades Comportamentais".
                  </p>

                  <p className="text-gray-700 mb-4">
                    Todos os trabalhos aprovados serão publicados nos Anais do Congresso, que possui ISSN registrado, e
                    os melhores trabalhos serão convidados para publicação em edição especial da Revista Brasileira de
                    Ciências Forenses.
                  </p>
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 text-yellow-800">
                    <div className="flex">
                      ...
                      <p>
                        <strong>Importante:</strong> Para submeter um trabalho, é necessário que pelo menos um dos
                        autores esteja inscrito no evento até a data de divulgação dos resultados.
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside text-gray-700 space-y-1">
                        ...
                        <li>Criminalística e Ciências Forenses</li>
                        <li>Balística Forense</li>
                        <li>Documentoscopia e Grafoscopia</li>
                        <li>Genética Forense e Biologia Molecular</li>
                        <li>Toxicologia Forense</li>
                        <li>Computação Forense e Crimes Cibernéticos</li>
                        <li>Psicologia e Psiquiatria Forense</li>
                        <li>Antropologia Forense</li>
                        <li>Odontologia Legal</li>
                        <li>Química Forense</li>
                        <li>Entomologia Forense</li>
                        <li>Inteligência Artificial aplicada às Ciências Forenses</li>
                        <li>Inovações Tecnológicas em Ciências Forenses</li>
                        <li>Aspectos Éticos e Legais das Ciências Forenses</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <ol className="list-decimal list-inside text-gray-700 space-y-4">
                      <li className="pl-2">
                        ...
                        usuário e senha. Caso não possua cadastro, será necessário criar uma conta.
                      </li>
                      <li className="pl-2">
