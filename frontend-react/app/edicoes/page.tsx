        ...
        <section className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-10 md:py-14">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center">
              <h1 className="text-2xl md:text-3xl font-bold mb-2 text-[#2279ea]">Edições Anteriores</h1>
              <p className="text-base md:text-lg text-gray-200 mb-4">Histórico do CONCIFA</p>
            </div>
          </div>
        </section>
